<form action="" method="post">
  <div class="container col-xl-3 mt-5">
    ...
    <div class="form-outline mb-4">
      <input type="text" id="name" name="name" class="form-control" placeholder="ex: Fulano da Silva" />
      <label class="form-label" for="name">Nome completo</label>
    </div>

    <!-- Email input -->
    <div class="form-outline mb-4">
      <input type="email" id="email" name="email" class="form-control" placeholder="ex: fulano@email.com.br" />
      <label class="form-label" for="email">Endereço de E-mail</label>
    </div>

    <!-- Phone input -->
    <div class="form-outline mb-4">
      <input type="tel" id="phone" name="phone" class="form-control" placeholder="ex: 21 6546-5555" />
